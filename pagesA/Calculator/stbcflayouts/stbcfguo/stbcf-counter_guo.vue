	...
	<view>
		...
		<form>
			<view class="cu-form-group" v-show="showSelector.stbcfGuo_sfyj">
				...
				<view class="title m-left" v-model="needVal.stbcfGuo_sfyj">{{multiSelector.stbcfGuo_sfyj[pickerIndex.stbcfGuo_sfyj]}}</view>
...
<script>
	...
	export default {
		...
		beforeCreate() {
			uni.request({
				url:'https://www.dulifei.com/json/stbcfs1.json',
				success: (res) => {
