	...
	<view class="cu-modal" :class="showModalName== modalName ?'show':''" @touchmove.stop.prevent="moveHandle">
		<view class="cu-dialog">
			<view class="cu-bar bg-white justify-end">
				<view class="content">城市规划设计收费复杂调整系数</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				modalName:'csghYue_fzxs',
				tzxsList:[
					{content:"默认系数1.0",val:"1.0"},
					{content:"对于地形复杂、技术难度高以及审查层次多的规划项目，可根据工作量的增加的情况，乘以1.1~1.3系数",val:"1.2"},
					{content:"经济特区可按照本标准乘以1.3的系数收费",val:"1.3"}
				]
			}
		}
	}
