		...
		<view class="navigation-bar">
			<view class="sjfjsjg">
				<view class="sjftable">
					...
					<text class="text-blue">海域使用金征收标准计算结果</text>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[0]}}</view>
					<input name="input" class="sjfInput" v-model="result.hyjzfGuo_sfjj" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[1]}}</view>
					<input name="input" class="sjfInput" v-model="result.hyjzfGuo_zq" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[2]}}</view>
					<input name="input" class="sjfInput" v-model="result.hyjzfGuo_zh" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
