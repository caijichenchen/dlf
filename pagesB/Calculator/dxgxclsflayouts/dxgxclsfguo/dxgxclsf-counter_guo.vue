	...
	<view>
		...
		<form>
			...
			<view class="cu-form-group" >
				...
				<picker class="select" @change="pickerChoose" data-index="indexfzcd" data-arr="dxgxclsfGuo_fzcd" :value="indexfzcd"
			...
			<view class="cu-form-group" >
				...
				<picker class="select" @change="pickerChoose" data-index="index0" data-arr="dxgxclsfGuo_qwfjtz" :value="index0"
