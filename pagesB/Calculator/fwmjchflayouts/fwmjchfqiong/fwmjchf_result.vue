		...
		<view class="navigation-bar">
			<view class="sjfjsjg">
				<view class="sjftable">
					...
					<text>房屋面积测绘费计算结果</text>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[0]}}</view>
					<input name="input" class="sjfInput" v-model="result.fwmjchf_sfjj" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[1]}}</view>
					<input name="input" class="sjfInput" v-model="result.fwmjchf_zqchf" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[2]}}</view>
					<input name="input" class="sjfInput" v-model="result.fwmjchf_zhchf" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
	...
	export default {
		...
		data() {
			return {
				...
				showGroup: 1,
				config: {
					menuText: ['收费基价:', '折前测绘费:', '折后测绘费:','计算过程:'],
				},
			};
		},
	}
