		...
		<view class="navigation-bar">
			<view class="sjfjsjg">
				<view class="sjftable">
					...
					<text class="text-blue">湖南省项目代建费计算结果</text>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[0]}}</view>
					<input name="input" class="sjfInput" v-model="result.xmdjf_jj" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[1]}}</view>
					<input name="input" class="sjfInput" v-model="result.xmdjf_zqfy" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
				<view class="cu-form-group">
					<view class="title">{{config.menuText[2]}}</view>
					<input name="input" class="sjfInput" v-model="result.xmdjf_zhfy" /></input>
					<uni-tag text="元" type="defult"></uni-tag>
				</view>
	...
	export default {
		...
		data() {
			return {
				...
				showGroup: 1,
				config: {
					menuText: ['基价','折前代建服务费:', '折后代建服务费:',  '计算过程:'],
				},
			};
		},
	}
