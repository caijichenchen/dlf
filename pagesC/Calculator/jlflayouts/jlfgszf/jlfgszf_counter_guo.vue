	...
	<view>
		...
		<form>
			<view class="cu-form-group">
				...
				<view class="title m-left">粤建监协〔2015〕21号</view>
			</view>
...
<script>
	...
	import jlfgszfFjtz from "./jlfGszf_fjtz.vue"
	import jlfgszfFztz from "../jlf_fztz.vue"
	import jlfgszfBlb from "./jlfGszf_blb.vue"
	export default {
		mixins: [counterMixin],
		props:{
			index:{
