	...
	<view>
		...
		<form>
			...
			<view class="cu-form-group">
				...
				<picker class="select" @change="PickerChanges" :value="index0" :range="jlfChuan_fztz">
...
<script>
	...
	export default {
		...
		methods:{
			PickerChanges(e){
				this.index0 = e.datail.value
				this.needVal.jlfChuan_fztz = this.jlfChuan_fztz[this.index0]
			},
			showdzzk(e) {
