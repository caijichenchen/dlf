	...
	<view>
		...
		<form>
			<view class="cu-form-group">
				...
				<view class="title m-left">黔监协[2015]10号</view>
			</view>
			<view class="cu-form-group" >
				<view class="title">计费额</view>
				<input type="digit" v-model="needVal.jlfQian_jfe"></input>
			...
			<view class="cu-form-group">
				...
				<button class="m-r" type="primary" size="mini" @tap="showModal" data-target="jlfQian_fztz">点击选择</button>
			</view>
			<view class="cu-form-group">
			...
			<view class="cu-form-group">
				...
				<input type="digit" v-model="needVal.jlfQian_fjtz"></input>
				<uni-tag text="%" type="defult"></uni-tag>
				<button class="m-r" type="primary" size="mini" @tap="showModal" data-target="jlfQian_fjtz">点击选择</button>
			</view>
			<view class="cu-form-group">
				<view class="title">打折折扣</view>
				<input type="digit" v-model="needVal.jlfQian_dzzk" /></input>
				<uni-tag text="%" type="defult"></uni-tag>
