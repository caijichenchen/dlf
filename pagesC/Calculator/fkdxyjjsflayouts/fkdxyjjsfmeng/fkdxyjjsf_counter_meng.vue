	...
	<view>
		...
		<form>
			...
			<view class="cu-form-group" v-show="showSelector.fkdxyjjsfMeng_standard">
				...
				<button class="m-r" type="primary" size="mini" @tap="checkDeatil(1648,multiSelector.fkdxyjjsfMeng_standard[pickerIndex.fkdxyjjsfMeng_standard])">点击查看</button>
			</view>
			...
			<view class="cu-form-group" v-show="showSelector.fkdxyjjsfMeng4">
				...
				<input type="digit" v-model="needVal.fkdxyjjsfMeng_jsmj"></input>
			...
			<view class="cu-form-group">
				...
				<input type="digit" v-model="needVal.fkdxyjjsfMeng_discount" /></input>
				<uni-tag text="%" type="defult"></uni-tag>
...
<script>
	...
	export default {
		...
		beforeCreate() {
			uni.request({
				url:'https://www.dulifei.com/json/fkydjsfs/fkydjsfs-meng.json',
				success: (res) => {
