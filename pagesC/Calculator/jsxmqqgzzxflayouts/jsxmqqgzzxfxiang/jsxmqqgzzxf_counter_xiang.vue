	...
	<view>
		...
		<form>
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfXiang_gczj"></input>
			...
			<view class="cu-form-group" v-show="showSelector.jsxmqqgzzxfXiang_standard">
				...
				<button type="primary" size="mini" @tap="checkDeatil(912,multiSelector.jsxmqqgzzxfXiang_standard[pickerIndex.jsxmqqgzzxfXiang_standard])">点击查看</button>
			</view>
			...
			<view class="cu-form-group">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfXiang_hytzxs" /></input>
			...
			<view class="cu-form-group">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfXiang_fztzxs" /></input>
				<button type="primary" size="mini" @tap="showdzzk" :data-target="JSON.stringify(explain[1])">查看说明</button>
			</view>
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				<view class="title">打折折扣</view>
				<input type="digit" v-model="needVal.jsxmqqgzzxfXiang_discount"></input>
...
<script>
	...
	import jsxmqqgzzxfXiangHytzxs from "./jsxmqqgzzxfXiang_hytzxs.vue"
	...
	export default {
		...
		beforeCreate() {
			uni.request({
				url:'https://www.dulifei.com/json/kyjbgfs/kyjbgfs-xiang.json',
				success: (res) => {
		...
		watch:{
			inval(val){
				this.needVal.jsxmqqgzzxfXiang_gczj = val
			}
		}
	}
</script>
