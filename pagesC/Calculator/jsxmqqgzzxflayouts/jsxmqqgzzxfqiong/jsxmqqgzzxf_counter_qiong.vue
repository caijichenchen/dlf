	...
	<view>
		...
		<form>
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfQiong_gczj"></input>
			...
			<view class="cu-form-group" v-show="showSelector.jsxmqqgzzxfQiong_standard">
				...
				<button type="primary" size="mini" @tap="checkDeatil(306,multiSelector.jsxmqqgzzxfQiong_standard[pickerIndex.jsxmqqgzzxfQiong_standard])">点击查看</button>
			</view>
			...
			<view class="cu-form-group">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfQiong_hytzxs" /></input>
			...
			<view class="cu-form-group">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfQiong_fztzxs" /></input>
				<button type="primary" size="mini" @tap="showdzzk" :data-target="JSON.stringify(explain[1])">查看说明</button>
			</view>
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				<view class="title">打折折扣</view>
				<input type="digit" v-model="needVal.jsxmqqgzzxfQiong_discount"></input>
...
<script>
	...
	import jsxmqqgzzxfQiongHytzxs from "./jsxmqqgzzxfQiong_hytzxs.vue"
	...
	export default {
		...
		beforeCreate() {
			uni.request({
				url:'https://www.dulifei.com/json/kyjbgfs/kyjbgfs-qiong.json',
				success: (res) => {
		...
		watch:{
			inval(val){
				this.needVal.jsxmqqgzzxfQiong_gczj = val
			}
		}
	}
</script>
