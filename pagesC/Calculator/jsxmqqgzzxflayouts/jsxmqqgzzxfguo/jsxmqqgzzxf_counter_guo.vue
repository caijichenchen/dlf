	...
	<view>
		...
		<form>
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfGuo_gczj"></input>
			...
			<view class="cu-form-group">
				...
				<input type="digit" v-model="needVal.jsxmqqgzzxfGuo_hytzxs" /></input>
				<button type="primary" size="mini" @tap="showModal" data-target="jsxmqqgzzxfGuo_hytzxs">点击选择</button>
			</view>
			<view class="cu-form-group">
				<view class="title">复杂程度调整系数</view>
				<input type="digit" v-model="needVal.jsxmqqgzzxfGuo_fztzxs" /></input>
				<button type="primary" size="mini" @tap="showdzzk" :data-target="JSON.stringify(explain[1])">查看说明</button>
			</view>
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				<view class="title">打折折扣</view>
				<input type="digit" v-model="needVal.jsxmqqgzzxfGuo_discount"></input>
...
<script>
	...
	export default {
		...
		beforeCreate() {
			uni.request({
				url:'https://www.dulifei.com/json/kyjbgfs/kyjbgfs-guo.json',
				success: (res) => {
